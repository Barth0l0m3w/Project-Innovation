...
namespace server
{
	...
	abstract class Room
	{
		...
		public List<TcpMessageChannel> _members;
		public Dictionary<TcpMessageChannel, PlayerInfo> _infos;
		...
		protected Room (TCPGameServer pServer)
		{
			...
			_infos = new Dictionary<TcpMessageChannel, PlayerInfo>();
		}
		...
		protected virtual void addMember(TcpMessageChannel pMember)
		{
			...
			if (!_infos.ContainsKey(pMember))
			{
			_infos.Add(pMember, _server.GetPlayerInfo(pMember));
